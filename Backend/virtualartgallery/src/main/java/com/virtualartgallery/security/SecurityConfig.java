    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Payments Related
                        .requestMatchers(HttpMethod.POST, "/api/payments/system-update").hasAuthority("PAYMENT_SYSTEM") // Payment system auto-updates
                        .requestMatchers(HttpMethod.POST, "/api/payments/create-payment-intent").authenticated() // Authenticated users can initiate payment
                        .requestMatchers(HttpMethod.GET, "/api/payments/{orderId}").authenticated() // Authenticated users can view payment details
                        .requestMatchers(HttpMethod.POST, "/api/payments/confirm").authenticated() // Only authenticated users (with JWT) can confirm payment
